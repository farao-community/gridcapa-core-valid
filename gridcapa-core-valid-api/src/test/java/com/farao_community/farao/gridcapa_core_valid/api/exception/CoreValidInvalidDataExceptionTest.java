 ...
 */
class CoreValidInvalidDataExceptionTest {
    @Test
    void checkStandardExceptionUsage() {
        AbstractCoreValidException exception = new CoreValidInvalidDataException("Exception message");
        ...
        exception = new CoreValidInvalidDataException("Exception message", cause);
        assertEquals("Exception message", exception.getMessage());
