...
class CoreValidHandlerTest {
    ...
    void handleCoreValidRequestTest() {
        ...
        CoreValidRequest.CoreValidRequestBuilder builder = new CoreValidRequest.CoreValidRequestBuilder(requestId, dateTime, networkFile, cbcoraFile, glskFile,  refProgFile, studyPointsFile);
        CoreValidRequest request = builder.build();
